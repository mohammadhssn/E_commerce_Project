    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=12, unique=True, validators=[django.core.validators.RegexValidator(message='Invalid phone number.', regex='^(?:98|\\+98|0098|0)?9[0-9]{9}$')], verbose_name='Phone number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_number', models.CharField(max_length=12, validators=[django.core.validators.RegexValidator(message='Invalid phone number.', regex='^(?:98|\\+98|0098|0)?9[0-9]{9}$')], verbose_name='phone')),
                ('code', models.CharField(max_length=6, verbose_name='code')),
                ('created', models.DateTimeField(auto_now=True, verbose_name='created')),
                ('expire_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='expire_time')),
            ],
        ),
        migrations.CreateModel(
            name='Address',
            fields=[
                ...
                ('phone', models.CharField(max_length=12, validators=[django.core.validators.RegexValidator(message='Invalid phone number.', regex='^(?:98|\\+98|0098|0)?9[0-9]{9}$')], verbose_name='phone')),
