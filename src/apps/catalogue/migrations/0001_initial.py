    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='format: required, max-100', max_length=150, unique=True, verbose_name='category safe URL')),
                ('is_active', models.BooleanField(default=True, verbose_name='is_active')),
                ('is_sub', models.BooleanField(default=False, verbose_name='category is sub?')),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('parent', mptt.fields.TreeForeignKey(blank=True, help_text='format: not required', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='catalogue.category', verbose_name='parent of category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retail_price', models.IntegerField(error_messages={'name': {'max_length': 'the price must be positive'}}, help_text='format:price Toman', verbose_name='recommended retail price')),
                ('store_price', models.IntegerField(error_messages={'name': {'max_length': 'the price must be positive'}}, help_text='format:price Toman', verbose_name='regular store price')),
                ('sale_price', models.IntegerField(error_messages={'name': {'max_length': 'the price must be positive'}}, help_text='format:price Toman', verbose_name='sale price')),
